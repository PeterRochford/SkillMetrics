...
setup(
    ...
    version=skill_metrics.__version__,

    description='A package for calculating skill of model predictions against observations',
    ...
    packages=find_packages(exclude=['Documents', 'Examples']),
    ...
    install_requires=['numpy', 'matplotlib', 'xlsxwriter'],
