...
different color along with a legend with specified default markers & colors

A sixteenth example of how to create a Taylor diagram given one set of
reference observations and multiple model predictions for the quantity.
This is a variation of the tenth example (taylor10.py) where now a default 
is used of 4 marker symbols that are repeated with 6 colors. 
...
if __name__ == '__main__':
    ...
    # Define default list of marker symbols and colors
    default_colors = ["r", "b", "g", "c", "m", "y"]
    ...
    sm.taylor_diagram(sdev,crmsd,ccoef, markerLabel = label, 
                      default_colors = default_colors, default_markers = default_markers, 
                      taylor_options_file = 'taylor_option_config.csv')

    # Write plot to file if arguments say so
    None if args.no_save else plt.savefig('taylor16.png')
